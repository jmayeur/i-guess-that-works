...
keywords = ['engineering', 'tinkering', 'habits', 'best-practices', 'learning']
description = "On the tension between tinkering freely and the habits we build when no one is watching."
tags = ['engineering', 'best-practices', 'learning']
categories = ['best-practices', 'learning']
date = 2026-05-06T07:00:00-07:00
draft = false
+++
...
![ASCII Pool — a browser-based pool game built with Victor.js](/images/ascii-pool/588579247-5ea62c9a-12d3-4ad9-a1c0-4102d971857e.png)
...
I don't think that means that I need to start with TDD when I'm tinkering with [Victor.js](https://victorjs.org) to create an [ASCII pool game](https://github.com/jmayeur/ASCIIPool/blob/main/README.md), but I do think it means I need to check my enthusiasm when it comes to building something new and trying to get it committed & pushed as fast as AI+humanly possible. The real lesson for me is to spend more time understanding the value. If I want something to be durable, usable and maybe beneficial to someone else, I should treat it like a professional project. I should think about the steps I would take, and if I decide to bypass them be explicit with myself about why, what the risk is, and what I really hope to get out of the project.
