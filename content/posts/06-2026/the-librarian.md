...
author = 'Jeff Mayeur'
title = "The Librarian"
description = "Thinking through the missing role in agentic workplaces: not a supercharged PM, but a curator — someone who decides what context to keep, what to discard, and what story needs to be told."
keywords = ['ai', 'agentic', 'product management', 'curation', 'context', 'leadership', 'sdlc']
tags = ['ai', 'leadership', 'learning']
categories = ['learning']
date = 2026-06-12T07:00:00-07:00
draft = false
+++

{{% centerimage src="/images/the-librarian/Neurodiversity_display_University_of_Otago_Central_Library.jpg" alt="Book display highlighting neurodiverse authors and books about neurodiversity, at University of Otago Central Library" title="Neurodiversity display, University of Otago Central Library" width="70%" %}}

*"Book display highlighting neurodiverse authors and books about neurodiversity, at University of Otago Central Library" by [DrThneed](https://commons.wikimedia.org/wiki/File:Neurodiversity_display_University_of_Otago_Central_Library.jpg), licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).*
